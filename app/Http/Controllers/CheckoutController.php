...
class CheckoutController extends Controller
{
    ...
    public function checkout_success(Request $request)
    {
        ...
        $ticketCount = Order::latest()->value('order_quantity'); // so luong ve moi vua dat
    ...
    public function checkout_page()
    {
        ...
        $show_payment = Payment::latest('payment_id')->first();
    ...
    {
        $show_payment_QR = Payment::latest('payment_id')->first();
...
{
    $print_ticket = Order::latest('order_id')->first();
