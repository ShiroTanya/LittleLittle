...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./ThanhTonThnhCng.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="thanh-ton-thnh-cng">
      <div class="frame7">
        <img class="bg-icon1" alt="" src="./public/bg1.svg" />

        <div class="khung-cha-v1">
          <img class="group-icon15" alt="" src="./public/group7.svg" />
          ...
          <div class="v-1">
            <div class="v-11">
              ...
              <b class="b3">---</b>
              <img class="tick-1-icon" alt="" src="./public/tick-1.svg" />
            </div>
          </div>
          <div class="v-2">
            <div class="v-11">
            ...
            <img class="tick-1-icon1" alt="" src="./public/tick-1.svg" />
          </div>
          <div class="v-3">
            <div class="v-11">
              <img class="image-3-icon" alt="" src="./public/image-3@2x.png" />
          ...
          <img
            ...
            alt=""
            src="./public/previous-btn1.svg"
          />

          <img class="next-btn-icon1" alt="" src="./public/next-btn1.svg" />
        ...
        <div class="btn-xem-chi-tit4">
          ...
          <div class="xem-chi-tit-btn4">
            <img class="group-icon16" alt="" src="./public/group10.svg" />

            <div class="ti-v">
              <span class="ti-v-txt-container"
                >T <span class="span">ả</span>i vé
              </span>
            </div>
          </div>
        </div>
        <div class="btn-xem-chi-tit5">
          ...
          <div class="xem-chi-tit-btn4">
            ...
            <div class="ti-v">
              <span class="ti-v-txt-container"
                >G <span class="span1">ử</span>i Email
              </span>
            </div>
          </div>
        </div>
        <img
          ...
          alt=""
          src="./public/alvin-arnold-votay1-1@2x.png"
        />
      </div>
      <div class="thanh-ton-thnh">Thanh toán thành công</div>
      <div class="navigation3">
        <img class="navigation-child1" alt="" src="./public/vector-2.svg" />
        ...
        <div class="frame-parent12">
          ...
          <div class="group-parent7">
            <img class="group-icon18" alt="" src="./public/group4.svg" />

            <b class="sample-text9">0123456789</b>
          </div>
        </div>
        <img
          class="little-little-logo-ngang-13"
          alt=""
